  ...
  const projects = [
    {
      ...
      tech: ["Solidity", "Hardhat", "Tailwind CSS", "Ethers.js", "React.js"],
    ...
    },
    {
      ...
      tech: ["Solidity", "Hardhat", "CSS", "React.js", "Ethers.js"],
      network: "Base Mainnet",
    ...
    },
    {
      ...
      tech: ["Solidity", "Hardhat", "React.js", "IPFS", "Ethers.js", "Tailwind CSS"],
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              ...
              <img  
                src="/yusufimg.jpg"
                alt="Owoyemi Yusuf"
                className="relative w-48 h-48 md:w-64 md:h-64 rounded-full border-4 border-white/30 shadow-2xl bg-white/5 object-cover"
              />
            </div>
          </div>
        </div>
